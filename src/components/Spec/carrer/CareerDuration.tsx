...
interface CareerDurationProps {
  index: number
  startDate: string
  endDate: string | null
  handleCareerChange: (index: number, fieldName: 'startDate' | 'endDate', value: string | null) => void
}

export default function CareerDuration({ handleCareerChange, index, startDate, endDate }: CareerDurationProps) {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, fieldName: 'startDate' | 'endDate') => {
    handleCareerChange(index, fieldName, formatYYYYMM(e.target.value))
  }

  const handleBlur = (value: string | undefined | null, fieldName: 'startDate' | 'endDate') => {
    handleCareerChange(index, fieldName, padMonth(value))
  }
    ...
    <div className="w-full">
      ...
      <button
        ...
        onClick={() => {
          ...
          handleCareerChange(index, 'endDate', nextState ? null : '')
        }}
