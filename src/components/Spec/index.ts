...
//education
export { default as AddEduForm } from './education/AddEduForm'
export { default as EduDuration } from './education/EduDuration'
export { default as EduGrades } from './education/EduGrades'
export { default as EduMajor } from './education/EduMajor'
export { default as EduSchool } from './education/EduSchool'

//languageSkill
export { default as AddLangForm } from './language/AddLangForm'

//certification
export { default as AddCertForm } from './certification/AddCertForm'
export { default as CertName } from './certification/CertName'
...
export { default as CareerDuration } from './carrer/CareerDuration'
export { default as CareerContractType } from './carrer/CareerContractType'
