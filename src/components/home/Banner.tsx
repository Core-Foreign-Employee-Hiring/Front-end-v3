    ...
    <div className="relative h-[300px] w-full overflow-hidden">
      <div className="relative z-10 flex h-full flex-col items-center justify-center gap-y-[32px]">
        <div className="flex flex-col gap-y-2">
          <h1 className="kr-resume-lg text-center text-white">막막했던 한국 취업·창업 준비 KORFIT과 함께</h1>
          <div className="flex flex-col items-center justify-center">
            <p className="kr-title-sm text-white">복잡한 채용 절차부터 취업 역량 강화까지</p>
            <p className="kr-title-sm text-white">글로벌 인재를 위한 한국 커리어 준비의 모든 과정을 지원합니다</p>
          </div>
        </div>
        <Button
