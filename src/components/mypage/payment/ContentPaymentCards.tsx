  ...
  return (
    <div className="flex w-full flex-col gap-y-[32px]">
      <section className="flex flex-col items-start gap-y-[12px]">
        ...
        <p className="kr-subtitle-md text-gray5 whitespace-pre">{`구매 취소 및 환불 문의는 카카오톡 상담하기를 이용해 주세요.\n아래 신청 내역에 표시된 금액은 실제 결제 금액과 다를 수 있습니다. ‘영수증 보기’를 눌러 실제 결제 금액을 확인할 수 있습니다.`}</p>
      </section>
