    ...
    <div className="flex flex-col gap-y-3">
      ...
      <div className="flex cursor-pointer gap-x-2" onClick={handleAllAgreement}>
        ...
        <p className={`kr-subtitle-md ${isAllAgreed ? 'text-black' : 'text-gray5'}`}>
          {t('profile.terms_of_service.all_agree')}
        </p>
      </div>
