...
export default function MobileWorkConditions({
  workType,
  ...
  return (
    <div className="desktop:hidden flex flex-col gap-y-[24px]">
      <section className="flex h-fit w-full flex-col gap-y-2">
        <Label label={t('jobPost:detail.workConditions.title')} type={'subtitleLg'} />
        <div className="flex flex-col gap-y-[20px]">
          <div className="flex">
            <div className="text-gray4 kr-subtitle-md w-[80px]">
              {t('jobPost:detail.workConditions.workType.title')}
            </div>
