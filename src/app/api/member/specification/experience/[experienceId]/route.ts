...
export async function PUT(request: NextRequest, context: { params: Promise<{ experienceId: string }> }) {
  try {
    ...
    const endpoint = `/api/v2/member/specification/experience/${experienceId}`
