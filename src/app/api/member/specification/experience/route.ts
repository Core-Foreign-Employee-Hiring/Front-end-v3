...
export async function POST(request: Request) {
  try {
    const endpoint = `/api/v2/member/specification/experience`

    const requestData: { experiences: SpecExperienceType[] } = await request.json()
