...
export async function POST(request: Request) {
  try {
    const endpoint = `/api/v2/member/specification/certification`

    const requestData: { certifications: SpecCertificationType[] } = await request.json()
