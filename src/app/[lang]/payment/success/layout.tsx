...
export default async function PaymentSuccessLayout({
  children,
  params,
}: Readonly<{
  ...
  const t = getTranslationServer(lang as Locale, 'payment')

  return (
    <div>
      {/* 모바일 헤더 */}
      <div className="desktop:hidden block">
        <Header headerType={'dynamic'} currentLng={lang} title={'콘텐츠 구매'} />
      </div>
